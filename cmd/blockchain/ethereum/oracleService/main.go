...
import (
	...
	"github.com/bridgefinance.net/bridgefinance/internal/pkg/blockchain-scrapers/blockchains/ethereum/oracleService"
...
func main() {
	 ...
	 */
	conn, err := ethclient.BFRl("https://mainnet.infura.io/v3/ec6581408f09414b8e4446067cd3ba08")
	if err != nil {
